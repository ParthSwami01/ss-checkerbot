...
$url = "https://api.telegram.org/bot6067964534:AAGK8WdJV6C32HB9vbb7zUicZvGv4eRLDmg/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
